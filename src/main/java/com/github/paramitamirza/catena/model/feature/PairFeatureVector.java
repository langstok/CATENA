...
import com.github.paramitamirza.catena.parser.entities.*;
...
public class PairFeatureVector {
	...
	private FeatureEnum.PairType pairType;
	...
	public PairFeatureVector(Doc doc, Entity e1, Entity e2, String label, TemporalSignalList tempSignalList, CausalSignalList causalSignalList) {
		...
		if (e1 instanceof Event && e2 instanceof Event) {
			this.setPairType(FeatureEnum.PairType.event_event);
		} else if ((e1 instanceof Timex && e2 instanceof Event) ||
				(e1 instanceof Event && e2 instanceof Timex)) {
			this.setPairType(FeatureEnum.PairType.event_timex);
		} else if (e1 instanceof Timex && e2 instanceof Timex) {
			this.setPairType(FeatureEnum.PairType.timex_timex);
		}
	...
	public FeatureEnum.PairType getPairType() {
		return pairType;
	}

	public void setPairType(FeatureEnum.PairType pairType) {
	...
	public String getTokenAttribute(Entity e, FeatureEnum.FeatureName feature) {
		...
		if (e instanceof Timex && (((Timex)e).isDct() || ((Timex)e).isEmptyTag())) {
			...
			if (feature.equals(FeatureEnum.FeatureName.token) || feature.equals(FeatureEnum.FeatureName.lemma))
		...
		if (e instanceof Timex) {
			...
			if (currChunk.contains("B-") || currChunk.contains("I-")) {
				...
				if (currChunk.contains("B-")) {
					...
					String beforeChunk = beforeToken.getTokenAttribute(FeatureEnum.FeatureName.chunk);
					String beforePhrase;
					while (beforeChunk.contains("I-")) {
						beforePhrase = beforeChunk.substring(2);
						if (beforePhrase.equals(currPhrase))
							chunkText.add(0, beforeToken.getTokenAttribute(FeatureEnum.FeatureName.token));
						beforeToken = doc.getTokens().get(doc.getTokenArr().get(beforeToken.getIndex()-1));
						beforeChunk = beforeToken.getTokenAttribute(FeatureEnum.FeatureName.chunk);
					}
	...
	public ArrayList<String> getTokenAttribute(FeatureEnum.FeatureName feature) {
	...
	public String getCombinedTokenAttribute(FeatureEnum.FeatureName feature) {
		return getTokenAttribute(e1, feature) + "|" + getTokenAttribute(e2, feature);
	}
	
	public Boolean isSameTokenAttribute(FeatureEnum.FeatureName feature) {
	...
	protected String getEntityAttribute(Entity e, FeatureEnum.FeatureName feature) {
		if (e instanceof Event) {
			if (((Event)e).getAttribute(feature).equals("O")) {
				...
				if (relatedTid != null) {
					if (feature == FeatureEnum.FeatureName.tense) return doc.getTokens().get(relatedTid).getTense();
					else if (feature == FeatureEnum.FeatureName.aspect) return doc.getTokens().get(relatedTid).getAspect();
					else if (feature == FeatureEnum.FeatureName.polarity) return doc.getTokens().get(relatedTid).getPolarity();
				}
				return "NONE";
			} else {
	...
	public String getMateMainVerb(Entity e) {
		if (getTokenAttribute(e, FeatureEnum.FeatureName.mainpos).equals("v")) {
	...
	protected String getString(String startTokID, String endTokID) {
		...
		for (String tokID : tokIDs) {
			context.add(doc.getTokens().get(tokID).getTokenAttribute(FeatureEnum.FeatureName.token).toLowerCase());
		}
	...
	public String getSignalMateDependencyPath(Entity e, ArrayList<String> entArr, ArrayList<String> signalArr) {
		...
		for (String tokID : entArr) {
			...
			} else if (getTokenAttribute(e, FeatureEnum.FeatureName.mainpos).equals("adj") &&
			...
			if (getTokenAttribute(e, FeatureEnum.FeatureName.mainpos).equals("n")) {
...
//		return "O|O";
	...
	public void addToVector(FeatureEnum.FeatureName feature) throws Exception {
		List<String> fields = null;
		if (this instanceof EventEventFeatureVector) {
			fields = EventEventFeatureVector.fields;
		} else if (this instanceof EventTimexFeatureVector) {
		...
		if (fields != null) {
			switch(feature) {
				case id: 	
					...
					break;
				case token: 	
					getVectors().add(getTokenAttribute(e1, FeatureEnum.FeatureName.token).replace(" ", "_"));
					fields.add("token1");
					getVectors().add(getTokenAttribute(e2, FeatureEnum.FeatureName.token).replace(" ", "_"));
					fields.add("token2");
					break;
				case lemma: 	
					getVectors().add(getTokenAttribute(e1, FeatureEnum.FeatureName.lemma).replace(" ", "_"));
					fields.add("lemma1");
					getVectors().add(getTokenAttribute(e2, FeatureEnum.FeatureName.lemma).replace(" ", "_"));
					fields.add("lemma2");
					break;
				case tokenSpace: 	
					getVectors().add(getTokenAttribute(e1, FeatureEnum.FeatureName.token));
					fields.add("token1");
					getVectors().add(getTokenAttribute(e2, FeatureEnum.FeatureName.token));
					fields.add("token2");
					break;
				case lemmaSpace: 	
					getVectors().add(getTokenAttribute(e1, FeatureEnum.FeatureName.lemma));
					fields.add("lemma1");
					getVectors().add(getTokenAttribute(e2, FeatureEnum.FeatureName.lemma));
					fields.add("lemma2");
					break;
				case tokenChunk: 	
					...
					break;
				case pos:
					getVectors().add(getTokenAttribute(e1, FeatureEnum.FeatureName.pos));
					fields.add("pos1");
					getVectors().add(getTokenAttribute(e2, FeatureEnum.FeatureName.pos));
					fields.add("pos2");
					break;
				case mainpos:
					getVectors().add(getTokenAttribute(e1, FeatureEnum.FeatureName.mainpos));
					fields.add("mainpos1");
					getVectors().add(getTokenAttribute(e2, FeatureEnum.FeatureName.mainpos));
					fields.add("mainpos2");
					break;
				case chunk:
					getVectors().add(getTokenAttribute(e1, FeatureEnum.FeatureName.chunk));
					fields.add("chunk1");
					getVectors().add(getTokenAttribute(e2, FeatureEnum.FeatureName.chunk));
					fields.add("chunk2");
					break;
				case ner:
					getVectors().add(getTokenAttribute(e1, FeatureEnum.FeatureName.ner));
					fields.add("ner1");
					getVectors().add(getTokenAttribute(e2, FeatureEnum.FeatureName.ner));
					fields.add("ner2");
					break;
				case supersense:
					getVectors().add(getTokenAttribute(e1, FeatureEnum.FeatureName.supersense));
					fields.add("supersense1");
					getVectors().add(getTokenAttribute(e2, FeatureEnum.FeatureName.supersense));
					fields.add("supersense2");
					break;
				case posCombined:
					getVectors().add(getCombinedTokenAttribute(FeatureEnum.FeatureName.pos));
					fields.add("pos");
					break;
				case mainposCombined:
					getVectors().add(getCombinedTokenAttribute(FeatureEnum.FeatureName.mainpos));
					fields.add("mainpos");
					break;
				case chunkCombined:
					getVectors().add(getCombinedTokenAttribute(FeatureEnum.FeatureName.chunk));
					fields.add("chunk");
					break;
				case nerCombined:
					getVectors().add(getCombinedTokenAttribute(FeatureEnum.FeatureName.ner));
					fields.add("ner");
					break;
				case supersenseCombined:
					getVectors().add(getCombinedTokenAttribute(FeatureEnum.FeatureName.supersense));
					fields.add("supersense");
					break;
				case samePos:
					getVectors().add(isSameTokenAttribute(FeatureEnum.FeatureName.pos) ? "TRUE" : "FALSE");
					fields.add("samePos");
					break;
				case sameMainPos:
					getVectors().add(isSameTokenAttribute(FeatureEnum.FeatureName.mainpos) ? "TRUE" : "FALSE");
				...
				case eventClass:
					if (this instanceof EventEventFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.eventClass));
						fields.add("eventClass1");
						getVectors().add(getEntityAttribute(e2, FeatureEnum.FeatureName.eventClass));
						fields.add("eventClass2");
					} else if (this instanceof EventTimexFeatureVector) {
						this.getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.eventClass));
						fields.add("eventClass");
					}
					break;
				case tense:
					if (this instanceof EventEventFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.tense));
						fields.add("tense1");
						getVectors().add(getEntityAttribute(e2, FeatureEnum.FeatureName.tense));
						fields.add("tense2");
					} else if (this instanceof EventTimexFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.tense));
						fields.add("tense");
				...
				case aspect:
					if (this instanceof EventEventFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.aspect));
						fields.add("aspect1");
						getVectors().add(getEntityAttribute(e2, FeatureEnum.FeatureName.aspect));
						fields.add("aspect2");
					} else if (this instanceof EventTimexFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.aspect));
						fields.add("aspect");
				...
				case tenseAspect:
					if (this instanceof EventEventFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.tense) + "-" + getEntityAttribute(e1, FeatureEnum.FeatureName.aspect));
						fields.add("tense-aspect1");
						getVectors().add(getEntityAttribute(e2, FeatureEnum.FeatureName.tense) + "-" + getEntityAttribute(e2, FeatureEnum.FeatureName.aspect));
				...
				case polarity:
					if (this instanceof EventEventFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.polarity));
						fields.add("polarity1");
						getVectors().add(getEntityAttribute(e2, FeatureEnum.FeatureName.polarity));
				...
				case eventClassCombined:
					if (this instanceof EventEventFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.eventClass) + "|" +
								getEntityAttribute(e2, FeatureEnum.FeatureName.eventClass));
				...
				case tenseCombined:
					if (this instanceof EventEventFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.tense) + "|" +
								getEntityAttribute(e2, FeatureEnum.FeatureName.tense));
				...
				case aspectCombined:
					if (this instanceof EventEventFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.aspect) + "|" +
								getEntityAttribute(e2, FeatureEnum.FeatureName.aspect));
				...
				case tenseAspectCombined:
					if (this instanceof EventEventFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.tense) + "-" + getEntityAttribute(e1, FeatureEnum.FeatureName.aspect) + "|" +
								getEntityAttribute(e2, FeatureEnum.FeatureName.tense) + "-" + getEntityAttribute(e2, FeatureEnum.FeatureName.aspect));
				...
				case polarityCombined:
					if (this instanceof EventEventFeatureVector) {
						getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.polarity) + "|" +
								getEntityAttribute(e2, FeatureEnum.FeatureName.polarity));
					...
					break;
				case sameEventClass:
					getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.eventClass).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.eventClass)) ? "TRUE" : "FALSE");
					fields.add("sameEventClass");
					break;
				case sameTense:
					getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.tense).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.tense)) ? "TRUE" : "FALSE");
					fields.add("sameTense");
					break;
				case sameAspect:
					getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.aspect).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.aspect)) ? "TRUE" : "FALSE");
					fields.add("sameAspect");
					break;
				case sameTenseAspect:
					getVectors().add((getEntityAttribute(e1, FeatureEnum.FeatureName.tense).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.tense)) &&
							getEntityAttribute(e1, FeatureEnum.FeatureName.aspect).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.aspect))) ? "TRUE" : "FALSE");
					fields.add("sameTenseAspect");
					break;
				case samePolarity:
					getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.polarity).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.polarity)) ? "TRUE" : "FALSE");
					fields.add("samePolarity");
					break;
				case timexType:
					getVectors().add(getEntityAttribute(e2, FeatureEnum.FeatureName.timexType));
					fields.add("timexType");
					break;
				case timexValue:
					getVectors().add(getEntityAttribute(e2, FeatureEnum.FeatureName.timexValue));
					fields.add("timexValue");
					break;
				case timexValueTemplate:
					getVectors().add(getEntityAttribute(e2, FeatureEnum.FeatureName.timexValueTemplate));
					fields.add("timexValueTemplate");
					break;
				case timexTypeValueTemplate:
					getVectors().add(getEntityAttribute(e2, FeatureEnum.FeatureName.timexType) + "|" +
							getEntityAttribute(e2, FeatureEnum.FeatureName.timexValueTemplate));
					fields.add("timexValueTemplate");
					break;
				case dct:
					getVectors().add(getEntityAttribute(e2, FeatureEnum.FeatureName.dct));
					fields.add("dct");
					break;
				case mainVerb:
					if (this instanceof EventEventFeatureVector) {
	...
	public void addBinaryFeatureToVector(FeatureEnum.FeatureName feature) throws Exception {
		List<String> fields = null;
		if (this instanceof EventEventFeatureVector) {
			fields = EventEventFeatureVector.fields;
		} else if (this instanceof EventTimexFeatureVector) {
		...
		if (fields != null) {
			switch(feature) {
				case id: 	
					...
					break;
				case pos:
					String e1Pos = getTokenAttribute(e1, FeatureEnum.FeatureName.pos);
					String e2Pos = getTokenAttribute(e2, FeatureEnum.FeatureName.pos);
					...
					break;
				case mainpos:
					String e1Mpos = getTokenAttribute(e1, FeatureEnum.FeatureName.mainpos);
					String e2Mpos = getTokenAttribute(e2, FeatureEnum.FeatureName.mainpos);
					...
					break;
				case chunk:
					String e1Chunk = getTokenAttribute(e1, FeatureEnum.FeatureName.chunk);
					String e2Chunk = getTokenAttribute(e2, FeatureEnum.FeatureName.chunk);
					...
					break;
				case samePos:
					getVectors().add(isSameTokenAttribute(FeatureEnum.FeatureName.pos) ? "1" : "0");
					fields.add("samePos");
					break;
				case sameMainPos:
					getVectors().add(isSameTokenAttribute(FeatureEnum.FeatureName.mainpos) ? "1" : "0");
					fields.add("sameMainPos");
					break;
				case entDistance:
					//getVectors().add(getEntityDistance().toString());
				...
				case eventClass:
					if (this instanceof EventEventFeatureVector) {
						for (String s : this.ev_class) {
							if (s.equals(getEntityAttribute(e1, FeatureEnum.FeatureName.eventClass))) getVectors().add("1");
							else getVectors().add("0");
							fields.add("e1class_" + s);
						}
						for (String s : this.ev_class) {
							if (s.equals(getEntityAttribute(e2, FeatureEnum.FeatureName.eventClass))) getVectors().add("1");
							else getVectors().add("0");
				...
				case tense:
					if (this instanceof EventEventFeatureVector) {
						for (String s : this.ev_tense) {
							if (s.equals(getEntityAttribute(e1, FeatureEnum.FeatureName.tense))) getVectors().add("1");
							else getVectors().add("0");
							fields.add("e1tense_" + s);
						}
						for (String s : this.ev_tense) {
							if (s.equals(getEntityAttribute(e2, FeatureEnum.FeatureName.tense))) getVectors().add("1");
							else getVectors().add("0");
				...
				case aspect:
					if (this instanceof EventEventFeatureVector) {
						for (String s : this.ev_aspect) {
							if (s.equals(getEntityAttribute(e1, FeatureEnum.FeatureName.aspect))) getVectors().add("1");
							else getVectors().add("0");
							fields.add("e1aspect_" + s);
						}
						for (String s : this.ev_aspect) {
							if (s.equals(getEntityAttribute(e2, FeatureEnum.FeatureName.aspect))) getVectors().add("1");
							else getVectors().add("0");
				...
				case polarity:
					if (this instanceof EventEventFeatureVector) {
						if (getEntityAttribute(e1, FeatureEnum.FeatureName.polarity).equals("neg")) getVectors().add("0");
						else getVectors().add("1");
						fields.add("e1polarity");
						if (getEntityAttribute(e2, FeatureEnum.FeatureName.polarity).equals("neg")) getVectors().add("0");
						else getVectors().add("1");
					...
					break;
				case sameEventClass:
					getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.eventClass).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.eventClass)) ? "1" : "0");
					fields.add("sameEventClass");
					break;
				case sameTense:
					getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.tense).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.tense)) ? "1" : "0");
					fields.add("sameTense");
					break;
				case sameAspect:
					getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.aspect).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.aspect)) ? "1" : "0");
					fields.add("sameAspect");
					break;
				case sameTenseAspect:
					getVectors().add((getEntityAttribute(e1, FeatureEnum.FeatureName.tense).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.tense)) &&
							getEntityAttribute(e1, FeatureEnum.FeatureName.aspect).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.aspect))) ? "1" : "0");
					fields.add("sameTenseAspect");
					break;
				case samePolarity:
					getVectors().add(getEntityAttribute(e1, FeatureEnum.FeatureName.polarity).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.polarity)) ? "1" : "0");
					fields.add("samePolarity");
					break;
				case timexType:
					for (String s : this.tmx_type) {
						if (s.equals(getEntityAttribute(e2, FeatureEnum.FeatureName.timexType))) getVectors().add("1");
						else getVectors().add("0");
						fields.add("ttype_" + s);
					}
					break;
...
//					}
	...
	public void addPhraseFeatureToVector(FeatureEnum.FeatureName feature) throws Exception {
		List<String> fields = null;
		if (this instanceof EventEventFeatureVector) {
			fields = EventEventFeatureVector.fields;
		} else if (this instanceof EventTimexFeatureVector) {
