...
import com.github.paramitamirza.catena.parser.entities.Event;
...
public class EventEventFeatureVector extends PairFeatureVector{
	...
	public Double getWordSimilarity() {
		...
		return rc.calcRelatednessOfWords(getTokenAttribute(e1, FeatureEnum.FeatureName.lemma), getTokenAttribute(e2, FeatureEnum.FeatureName.lemma));
	}
	...
	public ArrayList<String> getEntityAttributes() {
		...
		entityAttrs.add(getEntityAttribute(e1, FeatureEnum.FeatureName.eventClass));
		entityAttrs.add(getEntityAttribute(e2, FeatureEnum.FeatureName.eventClass));
		entityAttrs.add(getEntityAttribute(e1, FeatureEnum.FeatureName.tense));
		entityAttrs.add(getEntityAttribute(e2, FeatureEnum.FeatureName.tense));
		entityAttrs.add(getEntityAttribute(e1, FeatureEnum.FeatureName.aspect));
		entityAttrs.add(getEntityAttribute(e2, FeatureEnum.FeatureName.aspect));
		entityAttrs.add(getEntityAttribute(e1, FeatureEnum.FeatureName.polarity));
		entityAttrs.add(getEntityAttribute(e2, FeatureEnum.FeatureName.polarity));
		return entityAttrs;
	}
	
	public ArrayList<String> getCombinedEntityAttributes() {
		ArrayList<String> entityAttrs = new ArrayList<String>();
		entityAttrs.add(getEntityAttribute(e1, FeatureEnum.FeatureName.eventClass) + "|" + getEntityAttribute(e2, FeatureEnum.FeatureName.eventClass));
		entityAttrs.add(getEntityAttribute(e1, FeatureEnum.FeatureName.tense) + "-" + getEntityAttribute(e1, FeatureEnum.FeatureName.aspect) + "|" +
				getEntityAttribute(e2, FeatureEnum.FeatureName.tense) + "-" + getEntityAttribute(e2, FeatureEnum.FeatureName.aspect));
		entityAttrs.add(getEntityAttribute(e1, FeatureEnum.FeatureName.polarity) + "|" + getEntityAttribute(e2, FeatureEnum.FeatureName.polarity));
		return entityAttrs;
	}
	
	public ArrayList<String> getSameEntityAttributes() {
		ArrayList<String> entityAttrs = new ArrayList<String>();
		entityAttrs.add(getEntityAttribute(e1, FeatureEnum.FeatureName.eventClass).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.eventClass)) ? "TRUE" : "FALSE");
		entityAttrs.add((getEntityAttribute(e1, FeatureEnum.FeatureName.tense) + "-" + getEntityAttribute(e1, FeatureEnum.FeatureName.aspect)).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.tense) + "-" + getEntityAttribute(e2, FeatureEnum.FeatureName.aspect)) ? "TRUE" : "FALSE");
		entityAttrs.add(getEntityAttribute(e1, FeatureEnum.FeatureName.polarity).equals(getEntityAttribute(e2, FeatureEnum.FeatureName.polarity)) ? "TRUE" : "FALSE");
		return entityAttrs;
	}
	...
	public String getMateDependencyPath() {
		...
		if (isSameSentence()) {
			...
			if (getTokenAttribute(e1, FeatureEnum.FeatureName.mainpos).equals("v")) {
				tokenArr1.add(getMateHeadVerb(tokenID1));
			} else if (getTokenAttribute(e1, FeatureEnum.FeatureName.mainpos).equals("adj") &&
				getMateVerbFromAdj(tokenID1) != null) {
				tokenArr1.add(getMateVerbFromAdj(tokenID1));
			} else {
				tokenArr1.add(tokenID1);
			}
			if (getTokenAttribute(e2, FeatureEnum.FeatureName.mainpos).equals("v")) {
				tokenArr2.add(getMateHeadVerb(tokenID2));
			} else if (getTokenAttribute(e2, FeatureEnum.FeatureName.mainpos).equals("adj") &&
