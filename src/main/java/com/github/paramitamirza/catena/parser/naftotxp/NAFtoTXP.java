package com.github.paramitamirza.catena.parser.naftotxp;


import eu.fbk.newsreader.naf.AddALINK;
import eu.fbk.newsreader.naf.AddTLINK;
import eu.fbk.newsreader.naf.RefTimeML;
import eu.fbk.newsreader.naf.TextProFileFormat;
import ixa.kaflib.*;
...
//		KAFDocument nafFile = KAFDocument.createFromStream(f);
		...
		HashMap<String, String> listConnectives = new HashMap<>();
				//AddConnectivesClasses.getListConnectives(nafFile);
	...
	public static HashMap<String, String> getTermIdCoeventId(KAFDocument nafFile) {
	...
	public static String[][] addEventPred(String[][] lines, String fileRef) {
	...
	public static String[][] addMorpho(String[][] lines, boolean tenseAspect, int endHeaderLine) throws IOException {
	 ...
	 */
	//private static Coref getCoreferences (String wid, KAFDocument nafFile) {
	public static HashMap<String, Coref> getCoreferences(KAFDocument nafFile) {
